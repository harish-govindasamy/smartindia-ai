        ...
        <div className="luxury-search-container">
          <div className="flex flex-col sm:flex-row gap-3 mb-4">
            ...
            <div className="relative min-w-[120px] sm:min-w-[150px]">
              ...
              <ChevronDown className="absolute right-3 sm:right-3 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-muted-foreground pointer-events-none flex-shrink-0" />
            </div>
